...
var _generate_mesh_str = Module['_generate_mesh_str'] = makeInvalidEarlyAccess('_generate_mesh_str');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['generate_mesh_str'] != 'undefined', 'missing Wasm export: generate_mesh_str');
